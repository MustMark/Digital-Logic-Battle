...
xst -ifn xst.scr
move clk_wizard_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clk_wizard_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk_wizard_exdes.ucf clk_wizard_exdes

echo 'Running map'
map -timing -pr b clk_wizard_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clk_wizard_exdes -w routed.ncd routed.v
cd ..
